...
def calculaOpcaoCompra(dias):
    ...
    while dias > 0:
        ...
        #Calcula a media dos ultimos n5 dias
        mm25 = calculoMedia25()
        ...
        elif x > mm25 and n_accoes > 0 and ((x - ultimo_preco) > ((ultimo_preco*7)/100)):
...
lista_res_2 = []
for f in range(10):
    lista_res_2.append(simulacao(100))
